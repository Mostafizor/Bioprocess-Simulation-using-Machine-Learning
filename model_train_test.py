...
online.to_excel('Data2/Optimised_Networks/manual_onlineT10 {x}_{y}_{a}_{b}_{c}.xlsx'.format(x=HL, y=HN1, a=EPOCHS, b=LR, c=BATCH_SIZE))
offline.to_excel('Data2/Optimised_Networks/manual_offlineT10 {x}_{y}_{a}_{b}_{c}.xlsx'.format(x=HL, y=HN1, a=EPOCHS, b=LR, c=BATCH_SIZE))
avg_mse.to_excel('Data2/Optimised_Networks/manual_avg_mseT10 {x}_{y}_{a}_{b}_{c}.xlsx'.format(x=HL, y=HN1, a=EPOCHS, b=LR, c=BATCH_SIZE))

torch.save(net.state_dict(), 'Data2/Optimised_Networks/Models/manualT10 {x}_{y}_{a}_{b}_{c}.pt'.format(x=HL, y=HN1, a=EPOCHS, b=LR, c=BATCH_SIZE))

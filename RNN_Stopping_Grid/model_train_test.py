...
online.to_excel('Data2/Optimised_Networks/online_manual 3 {x}_{y}_{a}_{b}_{c}.xlsx'.format(x=HL, y=HN, a=EPOCHS, b=LR, c=BATCH_SIZE))
offline.to_excel('Data2/Optimised_Networks/offline_manual 3 {x}_{y}_{a}_{b}_{c}.xlsx'.format(x=HL, y=HN, a=EPOCHS, b=LR, c=BATCH_SIZE))
avg_mse.to_excel('Data2/Optimised_Networks/avg_mse_manual 3 {x}_{y}_{a}_{b}_{c}.xlsx'.format(x=HL, y=HN, a=EPOCHS, b=LR, c=BATCH_SIZE))

torch.save(rnn.state_dict(), 'Data2/Optimised_Networks/Models/manual 3 {x}_{y}_{a}_{b}_{c}.pt'.format(x=HL, y=HN, z=HN, a=EPOCHS, b=LR, c=BATCH_SIZE))
...
class Net(nn.Module):
	...
	def __init__(self, HN1, HN2, HN3):	
		...
		self.fc3 = nn.Linear(self.HN2, self.HN3)
		self.fc4 = nn.Linear(self.HN3, 3)                                                    # Output Layer: each node takes in 15 values, contain 3 nodes (one for each rate of change: X, N and Lu) hence outputs 3 values.

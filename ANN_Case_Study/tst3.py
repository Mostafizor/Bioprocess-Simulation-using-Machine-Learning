...
print(scaler_test.inverse_transform([test_inputs[50][0], test_inputs[50][1], test_inputs[50][2], test_inputs[50][3]]))
...
# online.to_excel('Data3/Optimised_Networks/manual_online {x}_{y}-{z}_{a}_{b}_{c}.xlsx'.format(x=HL, y=HN1, z=HN2, a=EPOCHS, b=LR, c=BATCH_SIZE))
# offline.to_excel('Data3/Optimised_Networks/manual_offline {x}_{y}-{z}_{a}_{b}_{c}.xlsx'.format(x=HL, y=HN1, z=HN2, a=EPOCHS, b=LR, c=BATCH_SIZE))
# avg_mse.to_excel('Data3/Optimised_Networks/manual_avg_mse {x}_{y}-{z}_{a}_{b}_{c}.xlsx'.format(x=HL, y=HN1, z=HN2, a=EPOCHS, b=LR, c=BATCH_SIZE))

# torch.save(net.state_dict(), 'Data3/Optimised_Networks/Models/manual {x}_{y}-{z}_{a}_{b}_{c}.pt'.format(x=HL, y=HN1, z=HN2, a=EPOCHS, b=LR, c=BATCH_SIZE))
